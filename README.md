...
💡 Как проходить курс:  
🔹 Материалы готовятся и бубут появляться в этом оглавлении (на него можно подписаться) и в телеграме.  
...
- 💯 Коетракт сигналов `signals`
  - ⭐ Сигналы (готовится)
  - 💻 Примеры кода (готовится)
  - 🧑‍💻 Задания по сингалам (готовится)
...
| 2    | [🎧 Q&A #2](https://youtu.be/k4z4Z9GzjHk) | |
